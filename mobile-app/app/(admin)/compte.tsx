...
export default function AdminCompte() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }} edges={['top']}>
      <Header title="Mon compte" onBack={() => router.back()} hideRight />
      <KeyboardAvoidingView
        style={{ flex: 1 }}
      ...
      >
        ...
        >
          <View style={styles.identityBlock}>
            <Avatar size={88} initials={initials} />
            ...
            <View style={{ marginTop: 8 }}>
              <Badge label="ADMINISTRATEUR" variant="primary" small withDot />
            </View>
          </View>
          ...
          <Card padding={22}>
            ...
            <Field label="EMAIL">
              <View style={[styles.input, styles.readonly]}>
                <Text
                  style={{ flex: 1, fontSize: 14, color: colors.onSurfaceVariant }}
                  numberOfLines={1}
                >
                  {profile?.email ?? '—'}
                </Text>
